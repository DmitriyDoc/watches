<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"></a>Новый товар</li>
    </ol>
</section>
                ...
                <form action="<?=ADMIN;?>/product/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            <lable for="title">Наименование товара</lable>
                            <input type="text"
                                   name="title"
                                   class="form-control"
                                   id="title"
                        ...
                        <div class="form-group has-feedback">
                            <lable for="old_price">Старая цена</lable>
                            <input type="text"
                                   name="old_price"
                                   class="form-control"
                                   id="old_price"
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea  name="content" cols="80" rows="10" id="editor1">
                                <?php isset($_SESSION['form_data']['old_price']) ? $_SESSION['form_data']['old_price'] : null ?>
                             </textarea>
                        </div>

                ...
                <form action="<?=ADMIN;?>/category/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="keywords" class="form-control" id="keywords" placeholder="Ключевые слова" <?= h($category->keywords); ?>>
                        </div>

                        <div class="form-group has-feedback">
                            <lable for="description">Описание</lable>
                            <input type="text" name="description" class="form-control" id="description" placeholder="Описание" <?= h($category->description); ?>>
                        </div>
                    </div>

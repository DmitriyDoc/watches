...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= ADMIN; ?>/user"></i> Список пользователей </a></li>
                ...
                <form action="<?= ADMIN; ?>/user/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="password" class="form-control" name="password" id="password" placeholder="Введите парль, если хотите его изменить" required>
                        </div>
